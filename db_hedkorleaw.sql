...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2024 at 12:49 PM
...
INSERT INTO `cart` (`cart_id`, `product_id`, `order_id`, `user_id`, `amount`, `status`) VALUES
(5, 6, 5, 9, '3', 'รอการตรวจสอบ'),
(6, 7, 5, 9, '2', 'รอการตรวจสอบ'),
(7, 8, 6, 9, '1', 'รอการตรวจสอบ'),
(8, 6, 6, 12, '1', 'รอการตรวจสอบ');
...
--
-- Dumping data for table `deilver`
--

INSERT INTO `deilver` (`deilver_id`, `order_id`, `tracking_number`) VALUES
(1, 6, 'asda');
...
(2, 'จัดกิจกรรม Live สด เกี่ยวกับสินค้าชุมชนจังหวัดแม่ฮ่องสอน พบกับ สาวมากความสามารถคุณลูกพีช เจ้าของช่อง ', 'พรุ่งนี้เวลา 19.00 น. ศูนย์พัฒนาและแสดงสินค้าชุมชนจังหวัดแม่ฮ่องสอน จัดกิจกรรม Live สด เกี่ยวกับสินค้าชุมชนจังหวัดแม่ฮ่องสอนพบกับ สาวมากความสามารถคุณลูกพีช เจ้าของช่อง \" ลูกพีชChanel \"', ''),
(4, 'เปิดเมิงไต ชิมอาหารไทใหญ่ ชมสินค้าท้องถิ่น ครั้งที่ 16 ชวน ช้อป ชิม', 'ระหว่างวันที่ 6 - 10 ธันวาคม 2566 \r\n                 ตั้งแต่เวลา 18.00 - 21.00 น.\r\n              ณ ศูนย์ไทใหญ่ศึกษา อำเภอเมือง จังหวัดแม่ฮ่องสอน\r\n                เชิญชวนนักท่องเที่ยวหรื', 'editimg_65e592d4962fa.jpg');
...
CREATE TABLE `oder` (
  ...
  `status` varchar(64) NOT NULL DEFAULT 'รอชำระเงิน',
...
INSERT INTO `oder` (`oder_id`, `user_id`, `name`, `address`, `phone`, `price`, `date`, `datetime`, `img_order`, `status`, `tracking_no`) VALUES
(5, 9, 'ต้นไม้', '55/3 ต.ในเมือง อ.เมือง จ.เชียงใหม่ 50200', '0988884444', '820', '2024-02-08', '10:10:00', 'order_65c4d9d76a253.jpg', 'รอชำระเงิน', NULL),
(6, 12, 'ลูกกวาด', '19 ตรีรติแมนนชั่น', '0625678682', '200', '2024-03-04', '15:14:00', 'order_65e582f908d1b.png', 'รอชำระเงิน', NULL);
...
(12, 'KKwxd', '202cb962ac59075b964b07152d234b70', 'ธนารีย์ ', 'kwadwijit@gmail.com', 625678682, '19 gfgf', 'm');
...
--
ALTER TABLE `deilver`
  MODIFY `deilver_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
